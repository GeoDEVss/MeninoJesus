    ...
    <body>
        ...
        <main class="container my-5 px-4 px-lg-5">
            ...
            foreach ($artigos as $artigo) {
                if (!empty($artigo['principal'])) {
                    $principal = $artigo;
                    break;
                }
            }

            $secundarios = array_filter($artigos, function($a) use ($principal) {
                return $principal ? $a['view'] != $principal['view'] : true;
            });
            ?>
                ...
                <div class="row mb-5">
                    <div class="col-12">
                        <a href="/artigos.php?artigo=<?= $artigo['view'] ?>" class="text-decoration-none text-reset w-100">
                            <div class="card shadow destaque-card">
                                <img src="<?= $principal['banner'] ?>" class="card-img-top destaque-img" alt="">
                                <div class="destaque-overlay">
                                    <h2 class="destaque-titulo"><?= $principal['titulo'] ?></h2>
                                    <p class="destaque-resumo"><?= $principal['resumo'] ?></p>
                                </div>
                            </div>
                        </a>
                    </div>
                    ...
                    <div class="col-12 col-md-6 col-lg-4">
                        ...
                        <div class="card h-100 d-none d-lg-flex flex-column">
                            ...
                            <div class="card-body d-flex flex-column flex-grow-1">
                                ...
                                <a href="/artigos.php?artigo=<?= $artigo['view'] ?>" class="btn btn-artigo-page mt-auto">
                                    Ler mais
                                </a>
                            </div>
                        </div>
